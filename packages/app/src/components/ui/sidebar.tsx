...
const SIDEBAR_TRANSITION_DURATION = 'duration-50';
	...
	return (
		...
		>
			...
			<div
				...
				className={cn(
					`w-(--sidebar-width) relative bg-transparent transition-[width] ${SIDEBAR_TRANSITION_DURATION} ease-linear`,
			...
			<div
				...
				className={cn(
					`w-(--sidebar-width) fixed inset-y-0 z-10 hidden h-svh transition-[left,right,width] ${SIDEBAR_TRANSITION_DURATION} ease-linear md:flex`,
					side === 'left'
...
function SidebarGroupLabel({
	...
	return (
		<Comp
			...
			className={cn(
				`text-sidebar-foreground/70 ring-sidebar-ring outline-hidden flex h-8 shrink-0 items-center rounded-md px-2 text-xs font-medium transition-[margin,opacity] ${SIDEBAR_TRANSITION_DURATION} ease-linear focus-visible:ring-2 [&>svg]:size-4 [&>svg]:shrink-0`,
...
const sidebarMenuButtonVariants = cva(
	`peer/menu-button flex w-full items-center gap-2 overflow-hidden rounded-md p-2 text-left text-sm outline-hidden ring-sidebar-ring transition-[width,height,padding] ${SIDEBAR_TRANSITION_DURATION} ease-linear hover:bg-sidebar-accent hover:text-sidebar-accent-foreground focus-visible:ring-2 active:bg-sidebar-accent active:text-sidebar-accent-foreground disabled:pointer-events-none disabled:opacity-50 group-has-data-[sidebar=menu-action]/menu-item:pr-8 aria-disabled:pointer-events-none aria-disabled:opacity-50 data-[active=true]:bg-sidebar-accent data-[active=true]:font-medium data-[active=true]:text-sidebar-accent-foreground data-[state=open]:hover:bg-sidebar-accent data-[state=open]:hover:text-sidebar-accent-foreground group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2! [&>span:last-child]:truncate [&>svg]:size-4 [&>svg]:shrink-0`,
	{
		variants: {
			variant: {
